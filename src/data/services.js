 ...
 * before they have to ask. Rendered visibly on /services/ AND emitted as
 * FAQPage structured data — so the answers here are the answers on the page,
 * word for word. Changing one changes both; do not let them drift.
 *
